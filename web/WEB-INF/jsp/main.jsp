...
<div class="conteiner">
    ...
    <div>
        ...
        <br>
            <p style="text-align: center"><input class="btn-link" type="submit" value="More info about &quot;Tallink&quot;"/></p>
    ...
    <div>
        <form name="viewForm" method="POST" action="controller">
            ...
            <br>
            <p style="text-align: center"><input class="btn-link" type="submit" value="More info about &quot;Ляля Ратушна&quot;"/></p>
            <%--<a href="${pageContext.request.contextPath}/home"> <p style="text-align: center"> More info about "Silja Line"<p/>--%>
            <%--</a>--%>
        </form>
    </div>
